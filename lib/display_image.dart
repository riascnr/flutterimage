...
class _DisplayImagePageState extends State<DisplayImagePage> {
  ...
  Future<void> fetchImages() async {
    final response = await http.get(Uri.parse("http://10.10.24.36/flutter_image/fetch_images.php"));
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final imageUrl = "http://10.10.24.36/flutter_image/uploads/${imageInfo['file_name']}";
